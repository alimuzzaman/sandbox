(function(){"use strict";const r=e=>document.getElementById(e),fe={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;"},d=e=>String(e).replace(/[&<>"]/g,t=>fe[t]),q=e=>e.charAt(0).toUpperCase()+e.slice(1),l={data:{instances:[],plugins:[],seeds:[],servers:["apache","nginx","litespeed"],domains_ready:!1},busy:{},usage:null,paused:!1};async function M(e){return(await fetch(e)).json()}const me=()=>M("/api/instances"),Z=()=>M("/api/usage"),ee=(e,t)=>M(`/api/job/${e}?offset=${t}`),ge=e=>M(`/api/snapshots/${e}`);async function _(e){return(await fetch("/api/action",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify(e)})).json()}function he(e){const t=e.replace(/\/+$/,"").split("/").filter(Boolean);return t.length===0?{page:"home"}:t[0]==="create"&&t.length===1?{page:"create"}:t[0]==="usage"&&t.length===1?{page:"usage"}:t[0]==="instance"&&t[1]?{page:"instance",name:decodeURIComponent(t[1]),console:t[2]==="console"}:{page:"notfound"}}const T=()=>he(location.pathname);let W=()=>{};function ve(e){W=e}function m(e,t=!1){e!==location.pathname&&(t?history.replaceState({},"",e):history.pushState({},"",e)),W(T())}function D(e,t=!1){const n=`/instance/${encodeURIComponent(e)}`;return t?`${n}/console`:n}function ke(){window.addEventListener("popstate",()=>W(T())),document.addEventListener("click",e=>{var a,s;const t=(s=(a=e.target)==null?void 0:a.closest)==null?void 0:s.call(a,"a[data-link]");if(!t)return;const n=t.getAttribute("href")||"";n.startsWith("/")&&(e.preventDefault(),m(n))})}let ye=0;const O={};function we(){return"mcsel"+ ++ye}function H(e,t,n,a,s,o){const i=t.find(k=>k.v===n),c=i?i.label:t[0]?t[0].label:"";O[e]=a;const p=s?"opacity-50 pointer-events-none":"",be=o?"block w-full":"inline-block",xe=o?"w-full":"w-48";return`<div class="relative ${be}" data-csel="${e}">
    ...
    <div data-csel-pop class="hidden absolute z-[60] mt-1 ${xe} max-h-64 overflow-auto rounded-lg
      ...
      <div data-csel-list>
        ${t.map(k=>`<button type="button" data-v="${d(k.v)}" data-search="${d(k.label.toLowerCase())}"
          onclick="sb.cselPick('${e}','${d(k.v)}')"
  ...
  </div>`}const je=J;function V(){const e=l.data.instances.length;return`<div class="max-w-2xl mx-auto px-6 py-12">
  ...
  </div>`}function Ie(e){const t=e.domain||"",n=e.url.startsWith("https://"),a=t.endsWith(".sb");if(n)return`<span class="text-neutral-700 dark:text-neutral-200">${d(t)}</span>
    ...
    <button onclick="sb.showUsage()" class="ml-auto text-accent dark:text-blue-400 hover:underline">details →</button></div>`:'<div class="pt-1 border-t border-brd dark:border-brd-dark/60 mt-1 text-neutral-400">No Claude usage attributed to this instance yet.</div>'}function ae(e){if(!e)return V();if(e.pending)return`<div class="px-6 pt-8">
...
./sb test     # run its phpunit tests</code></pre>
  ...
  </div>`}function Ee(e,t){const n=t.map(a=>{const s=a.disabled?"opacity-40 pointer-events-none":"",o=a.danger?"text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/40":"text-neutral-700 dark:text-neutral-200 hover:bg-neutral-100 dark:hover:bg-neutral-800";return`<button type="button" ${a.disabled?"disabled":""}
    ...
    <div data-rowmenu-pop class="hidden absolute right-0 z-[60] mt-1 min-w-[10rem] py-1
      ...
      ${n}</div></span>`}function Me(e){var n;let t=!1;document.querySelectorAll("[data-rowmenu-pop]").forEach(a=>{const s=a.closest("[data-rowmenu]"),o=!a.classList.contains("hidden");s&&s.dataset.rowmenu===e&&(t=o),a.classList.add("hidden")}),!t&&((n=document.querySelector(`[data-rowmenu="${e}"] [data-rowmenu-pop]`))==null||n.classList.remove("hidden"))}function se(){document.querySelectorAll("[data-rowmenu-pop]").forEach(e=>e.classList.add("hidden"))}function _e(){document.addEventListener("click",e=>{var t,n;(n=(t=e.target)==null?void 0:t.closest)!=null&&n.call(t,"[data-rowmenu]")||se()})}function z(){const e=T();return e.page==="instance"?e.name:null}const x={play:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"/></svg>',stop:'<svg viewBox="0 0 24 24" fill="currentColor"><rect x="6" y="6" width="12" height="12" rx="1.5"/></svg>',restart:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 3-6.7L3 8"/><path d="M3 3v5h5"/></svg>',admin:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 5h5v5"/><path d="M19 5l-8 8"/><path d="M19 13v5a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h5"/></svg>',term:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 7l4 4-4 4"/><path d="M12 15h6"/></svg>',snapshot:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 4h-5L8 6H5a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-3z"/><circle cx="12" cy="13" r="3"/></svg>',restore:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9 9 0 0 0-6.7 3L3 8"/><path d="M3 3v5h5"/></svg>',trash:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M8 6V4h8v2"/><path d="M19 6l-1 14H6L5 6"/></svg>'};function De(e){const t=JSON.stringify(e.name),n=[e.running?{label:"Stop",icon:x.stop,js:`sb.act(${t},'stop')`}:{label:"Start",icon:x.play,js:`sb.act(${t},'start')`},{label:"Restart",icon:x.restart,js:`sb.act(${t},'restart')`,disabled:!e.running},{label:"Open admin",icon:x.admin,js:`window.open(${JSON.stringify(e.url+"/wp-admin")},'_blank')`,disabled:!e.running},{label:"Console",icon:x.term,js:`sb.navigate(${JSON.stringify(D(e.name,!0))})`,disabled:!e.running},{label:"Snapshot",icon:x.snapshot,js:`sb.doSnapshot(${t})`},{label:"Restore…",icon:x.restore,js:`sb.doRestore(${t})`}];return e.name!=="main"&&n.push({label:"Delete",icon:x.trash,js:`sb.doDelete(${t})`,danger:!0}),n}function Oe(e){const t=e.name===z(),n=e.running?"bg-emerald-500":"bg-neutral-300 dark:bg-neutral-600",s=l.busy[e.name]?`<svg class="spin ml-auto w-3.5 h-3.5 text-neutral-400 shrink-0" viewBox="0 0 24 24" fill="none">
        ...
        ${Ee("rm-"+e.name,De(e))}</span>`;return`<a href="${D(e.name)}" data-link class="group w-full text-left px-3 py-2 rounded
     ...
     ${s}</a>`}function oe(){if(document.querySelector("[data-rowmenu-pop]:not(.hidden)"))return;const e=l.data.instances;r("list").innerHTML=e.map(Oe).join("");const t=e.filter(n=>n.running).length;r("runcount").textContent=t+"/"+e.length,r("footstat").textContent=e.length?t+" of "+e.length+" running":"no instances yet"}let le="";function Ae(e){if(e.page==="instance"){const t=l.data.instances.find(n=>n.name===e.name)||null;return t?JSON.stringify(["instance",t.name,t.running,t.server,t.focus,t.project,!!t.pending,t.url,t.domain||"",l.busy[t.name]||"",l.data.plugins.length]):"instance:none:"+e.name}return e.page==="usage"?"usage:"+(l.usage?"loaded":"pending"):e.page}function Ne(){const e=document.activeElement;return!!(e&&(e.tagName==="INPUT"||e.tagName==="SELECT"||e.tagName==="TEXTAREA")||!r("modal").classList.contains("hidden"))}function Pe(e){switch(e.page){case"create":return Be();case"usage":return Te();case"instance":{const t=l.data.instances.find(n=>n.name===e.name)||null;return ae(t)}case"home":{const t=l.data.instances[0];return t?ae(t):V()}default:return V()}}function X(e){const t=T(),n=Ae(t);!e&&n===le||!e&&Ne()||(le=n,r("detail").innerHTML=Pe(t))}function G(){oe(),X(!0)}let A=null;function qe(e){if(e.type==="label")return`<div class="text-[11px] font-medium uppercase tracking-wide
      text-neutral-400 pt-1.5">${d(e.label||"")}</div>`;if(e.type==="select"){const n=we(),a=e.options||[],s=a.map(i=>({v:i,label:i})),o=e.value||a[0]||"";return`<input type="hidden" data-k="${e.key}" id="${n}_val" value="${d(o)}">`+H(n,s,o,i=>{document.getElementById(`${n}_val`).value=i},!1,!0)}if(e.type==="checkbox")return`<label class="flex items-center gap-2 text-[13px] text-neutral-700
      ...
      ${d(e.label||e.key||"")}</label>`;if(e.type==="checklist"){const a=(e.options||[]).map(s=>`
      <label class="flex items-start gap-2 px-2 py-1.5 rounded text-[13px] cursor-pointer
        hover:bg-neutral-100 dark:hover:bg-neutral-800">
        <input type="checkbox" data-checklist="${e.key}" value="${d(s.value)}"
          class="accent-accent w-3.5 h-3.5 mt-0.5">
        <span class="flex-1 min-w-0">
          <span class="text-neutral-800 dark:text-neutral-200">${d(s.label)}</span>
          ${s.desc?`<span class="block text-[11.5px] text-neutral-400 truncate">${d(s.desc)}</span>`:""}
    ...
    dark:bg-neutral-900 text-[13px] focus:border-accent outline-none">`}function R(e={}){return new Promise(t=>{A=t,r("mTitle").textContent=e.title||"",r("mDesc").textContent=e.desc||"",r("mFields").innerHTML=(e.fields||[]).map(qe).join("");const n=r("mOk");n.textContent=e.okText||"Confirm",n.className="px-3 py-1.5 rounded text-[13px] text-white border "+(e.danger?"bg-red-600 border-red-600 hover:bg-red-700":"bg-accent border-accent hover:bg-blue-700"),r("modal").classList.remove("hidden"),setTimeout(()=>{(r("mFields").querySelector("input,select")||n).focus()},30)})}function N(e){if(r("modal").classList.add("hidden"),A){const t=A;A=null,t(e)}}function We(){const e={};return r("mFields").querySelectorAll("[data-k]").forEach(t=>{t.dataset.type==="checkbox"?e[t.dataset.k]=t.checked:e[t.dataset.k]=(t.value||"").trim()}),r("mFields").querySelectorAll("[data-checklist-group]").forEach(t=>{const n=t.dataset.checklistGroup;e[n]=[...t.querySelectorAll("input[type=checkbox]:checked")].map(a=>a.value)}),e}function He(){r("mCancel").onclick=()=>N(null),r("mOk").onclick=()=>N(We()),r("modal").addEventListener("keydown",e=>{e.key==="Enter"&&r("mOk").click(),e.key==="Escape"&&N(null)}),r("modal").addEventListener("click",e=>{e.target===r("modal")&&N(null)})}const de={ok:"bg-emerald-50 text-emerald-800 border-emerald-200 dark:bg-emerald-950/70 dark:text-emerald-200 dark:border-emerald-800",err:"bg-red-50 text-red-800 border-red-200 dark:bg-red-950/70 dark:text-red-200 dark:border-red-900",info:"bg-app text-neutral-700 border-brd dark:bg-card-dark dark:text-neutral-200 dark:border-brd-dark"};function u(e,t="info"){const n=document.createElement("div");n.className="pointer-events-auto text-[13px] px-3.5 py-2 rounded-lg border shadow-md max-w-xs "+(de[t]||de.info),n.textContent=e,r("toasts").appendChild(n),setTimeout(()=>{n.style.opacity="0",setTimeout(()=>n.remove(),220)},2600)}let ie=async()=>{};function Fe(e){ie=e}function Ue(e){r("console").classList.remove("w-0"),r("console").classList.add("w-[26rem]"),r("conTitle").textContent=e,r("conBody").textContent="",r("conInputRow").classList.add("hidden"),r("conDot").className="w-2 h-2 rounded-full bg-amber-400 animate-pulse"}function Q(){r("console").classList.add("w-0"),r("console").classList.remove("w-[26rem]"),r("conInputRow").classList.add("hidden")}function h(e){const t=r("conBody");t.textContent+=e,t.scrollTop=t.scrollHeight}function Je(e,t){r("conTitle").textContent=e,r("conDot").className="w-2 h-2 rounded-full "+(t?"bg-emerald-500":"bg-red-500")}function K(e,t,n){l.paused=!0,Ue(n||"Working…");let a=0,s=!!n;const o=setInterval(async()=>{var c;const i=await ee(e,a);!s&&i.status&&(r("conTitle").textContent=i.status.replace(/ [✓✗]$/,""),s=!0),i.chunk?(h(i.chunk),a=(c=i.offset)!=null?c:a):typeof i.offset=="number"&&(a=i.offset),i.done&&(clearInterval(o),l.paused=!1,t&&delete l.busy[t],Je(i.status||"done",i.ok),u(i.status||"done",i.ok?"ok":"err"),await ie())},800)}let Y=null;const C=[];let f=-1,B=!1;function P(e){Y=e,r("console").classList.remove("w-0"),r("console").classList.add("w-[26rem]"),r("conTitle").textContent="Terminal — "+e,r("conDot").className="w-2 h-2 rounded-full bg-emerald-500",r("conBody").textContent.trim()||h("Terminal for "+e+` — runs inside the container.
Try: wp plugin list · wp option get siteurl · ls wp-content/plugins

`),r("conInputRow").classList.remove("hidden"),setTimeout(()=>r("conInput").focus(),60)}async function Ve(){if(B)return;const e=r("conInput"),t=e.value.trim();if(!t||!Y)return;C.push(t),f=C.length,e.value="",h("› "+t+`
`),B=!0,r("conDot").className="w-2 h-2 rounded-full bg-amber-400 animate-pulse";let n;try{n=await _({instance:Y,action:"term",cmd:t})}catch(o){h("error: "+o+`
`),B=!1;return}if(!n.job_id){h((n.output||"failed")+`
`),B=!1;return}let a=0;const s=setInterval(async()=>{var i;const o=await ee(n.job_id,a);o.chunk?(h(o.chunk),a=(i=o.offset)!=null?i:a):typeof o.offset=="number"&&(a=o.offset),o.done&&(clearInterval(s),B=!1,h(`
`),r("conDot").className="w-2 h-2 rounded-full bg-emerald-500",e.focus())},500)}function ze(e){const t=r("conInput");e.key==="Enter"?Ve():e.key==="ArrowUp"?(f>0&&(f--,t.value=C[f]||""),e.preventDefault()):e.key==="ArrowDown"&&(f<C.length-1?(f++,t.value=C[f]||""):(f=C.length,t.value=""),e.preventDefault())}function Xe(){r("conClose").onclick=Q,r("conInput").addEventListener("keydown",e=>ze(e))}let ce=async()=>{},v=()=>{};function Ge(e){ce=e.refresh,v=e.render}const ue={create:e=>"Creating "+e,delete:e=>"Deleting "+e,"start-all":()=>"Starting all sites","stop-all":()=>"Stopping all sites"};async function S(e,t,n={}){l.busy[e]=t,v();let a;try{a=await _(Object.assign({instance:e,action:t},n))}catch(s){delete l.busy[e],u("request failed: "+s,"err"),v();return}if(a.job_id){const s=ue[t]?ue[t](e):q(t)+" "+e;u(t.replace("-"," ")+" started…","info"),K(a.job_id,e,s)}else delete l.busy[e],a.ok?u(q(t)+" "+e+" ✓","ok"):u((a.output||"failed").split(`
`)[0],"err"),await ce()}async function L(e,t,n={}){let a;try{a=await _(Object.assign({instance:e,action:t},n))}catch(s){u("request failed: "+s,"err");return}if(a.job_id){const s={logs:"Logs",status:"Status",doctor:"Doctor",update:"Updating plugins",snapshot:"Snapshot",restore:"Restoring",seed:"Importing content",xdebug:"Xdebug",install:"Installing "+(n.slug||"plugin"),wp:"wp "+(n.args||"")};K(a.job_id,null,(s[t]||q(t))+" — "+e)}else u((a.output||"failed").split(`
`)[0],"err")}async function Qe(e,t){t===""?S(e,"unfocus"):t&&S(e,"focus",{slug:t})}async function Ke(e,t){const n=l.data.instances.find(s=>s.name===e);if(!t||n&&n.server===t)return;l.busy[e]="server",v();let a;try{a=await _({instance:e,action:"server",server:t})}catch(s){delete l.busy[e],v(),u("request failed: "+s,"err");return}a.job_id?(u("switching "+e+" → "+t+"…","info"),K(a.job_id,e,"Switching "+e+" → "+t)):(delete l.busy[e],v(),u((a.output||"failed").split(`
`)[0],"err"))}async function Ye(e){const t=await R({title:"Delete "+e,danger:!0,okText:"Delete",desc:"Stops + removes the stack, DB volume, and files. Type the name to confirm.",fields:[{key:"confirm",placeholder:e}]});t&&t.confirm===e?S(e,"delete",{confirm:e}):t&&u("name did not match — not deleted","err")}function Ze(e){const n=r("wpArgs").value.trim();if(!n){u("enter a wp-cli command","err");return}L(e,"wp",{args:n})}async function et(e){const t=await R({title:"Snapshot "+e,okText:"Save",desc:"Save the current DB + uploads under this name.",fields:[{key:"name",placeholder:"snapshot name"}]});t&&t.name&&L(e,"snapshot",{name:t.name})}async function tt(e){let t=[];try{t=(await ge(e)).snapshots||[]}catch(a){}if(!t.length){u("no snapshots for "+e,"err");return}const n=await R({title:"Restore "+e,danger:!0,okText:"Restore",desc:"Overwrites the current DB + uploads with the chosen snapshot.",fields:[{key:"name",type:"select",options:t}]});n&&n.name&&L(e,"restore",{name:n.name})}async function nt(e){const t=l.data.seeds||[];if(!t.length){u("no WXR files in runtime/seeds/","err");return}const n=await R({title:"Seed "+e,okText:"Import",desc:"Import a WXR content file into this instance.",fields:[{key:"file",type:"select",options:t}]});n&&n.file&&L(e,"seed",{file:n.file})}function at(e){const t=(r("plugQ").value||"").trim().toLowerCase().replace(/\s+/g,"-");if(!t){u("type a plugin slug to install","err");return}L(e,"install",{slug:t})}function rt(e){const t=(r("plugQ").value||"").toLowerCase().trim(),n=r("plugResults");if(!t){n.innerHTML="";return}const a=l.data.instances.find(o=>o.name===e),s=(l.data.plugins||[]).filter(o=>o.toLowerCase().includes(t)).slice(0,8);n.innerHTML=s.map(o=>`
    <div class="flex items-center gap-2 px-2.5 py-1.5 rounded border border-brd dark:border-neutral-800
      ...
      ${a&&a.focus===o?'<span class="text-[11px] text-emerald-500">focused</span>':`<button class="text-[12px] text-accent dark:text-blue-400 hover:underline"
        ...
        Press Install to fetch it from WordPress.org.</div>`}function st(e,t){navigator.clipboard.writeText(e).then(()=>{const n=t.textContent;t.textContent="copied",setTimeout(()=>{t.textContent=n},1200)})}async function ot(){try{l.usage=await Z()}catch(e){l.usage={available:!1}}v()}async function E(){if(l.paused)return;let e;try{e=await me()}catch(t){return}l.data=e,oe(),X(!1)}async function lt(){m("/usage"),r("detail").innerHTML='<div class="px-6 py-12 text-center text-neutral-400 text-[13px]">Loading Claude usage…</div>';try{l.usage=await Z()}catch(e){l.usage={available:!1}}X(!0)}function dt(){m("/")}function it(e){m(D(e))}function pe(){R({title:"How Claude works here",okText:"Got it",desc:`The sandbox gives Claude a live WordPress to act in, so it can verify instead of guess: run WP-CLI, hit REST + the DB, open pages in a real browser, read/edit your plugin's code, and tail logs. Say "focus <plugin>" or "work on <plugin>" in chat — Claude picks the matching environment, symlinks the plugin in, loads its code + context, and can build, reproduce, and fix end-to-end. One MCP server (mcp__sandbox__*) serves every project — each tool takes the project directory and resolves the right environment from the registry. Open an environment on the left for its exact snippet. It's real WordPress — break it freely, snapshot or delete anytime.`})}const ct={navigate:m,goHome:dt,selectInstance:it,showUsage:lt,showHelp:pe,openTerminal:P,doCreate:re,doDelete:Ye,doFocus:Qe,doServer:Ke,doSnapshot:et,doRestore:tt,doSeed:nt,doWp:Ze,doInstall:at,plugFilter:()=>rt(z()),loadUsageThenRender:ot,act:S,op:L,cselToggle:$e,cselPick:Ce,cselFilter:te,rowMenuToggle:Me,rowMenuClose:se,consoleClose:Q,copyText:st};window.sb=ct;function ut(){Ge({refresh:E,render:G}),Fe(E),He(),Xe(),Se(),_e(),ke(),r("newBtn").onclick=re,r("startAll").onclick=()=>S("*","start-all"),r("stopAll").onclick=()=>S("*","stop-all"),r("helpBtn").onclick=pe,r("termBtn").onclick=()=>{const t=z()||l.data.instances[0]&&l.data.instances[0].name;if(!t){u("create an instance first","err");return}m(D(t,!0)),P(t)},ve(t=>{G(),t.page==="instance"&&t.console?P(t.name):Q()}),G();const e=T();e.page==="instance"&&e.console&&P(e.name),bt()}const pt=5e3;function bt(){E(),window.setInterval(()=>{document.visibilityState==="visible"&&E()},pt),document.addEventListener("visibilitychange",()=>{document.visibilityState==="visible"&&E()})}ut()})();
