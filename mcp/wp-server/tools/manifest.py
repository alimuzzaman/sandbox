...
BUILTIN_TOOL_NAMES = {
    ...
    "jobs": ("job_start", "job_status", "job_list", "job_output", "job_follow", "job_metrics", "job_cancel", "job_artifacts", "job_artifact_get", "job_retry", "job_cleanup", "workspace_create", "workspace_list", "workspace_status", "workspace_reset", "workspace_destroy"),
