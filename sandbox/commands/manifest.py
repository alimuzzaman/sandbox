...
LEGACY_BRIDGE_COMMANDS = {
    ...
    "job-start": "jobs_runtime", "job-status": "jobs_runtime", "job-output": "jobs_runtime", "job-list": "jobs_runtime", "job-cancel": "jobs_runtime", "job-metrics": "jobs_runtime", "job-artifacts": "jobs_runtime", "job-artifact-get": "jobs_runtime", "job-reconcile": "jobs_runtime", "job-retention": "jobs_runtime", "job-matrix": "jobs_runtime",
