...
def _activation_gateway_healthy() -> bool:
    """Bounded loopback probe; never contacts a project backend."""
    from urllib.request import urlopen
    try:
        with urlopen("http://127.0.0.1:8766/healthz", timeout=0.25) as response:
