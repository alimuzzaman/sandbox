...
The self-test and unit suite remain fixture/local checks. The prior full verification ran 817 tests
in 43.171s with 1 skipped. Before the real-set checkpoint below, T060/T061/T069/T071/T072 and the
live T021 catalog-companion acceptance check remained protected operations requiring their
documented operator authorization; no restore, deletion, schedule activation, or live deployment
was performed by that hardening audit.
