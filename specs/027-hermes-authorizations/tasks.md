...
- [X] T022 [P] Verify the repaired Hermes upstream remote can fetch signed update history without changing the installed checkout, and record the bounded operator procedure (plan: live proof; completed read-only).
