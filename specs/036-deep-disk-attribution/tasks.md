...
- [x] T040 Propagate cancellation through CLI, MCP, service, and collectors and emit explicit cancelled or disconnected completion while preserving completed evidence per FR-003, FR-023, and the Deep Attribution Request entity (deterministic local coverage; public schema unchanged)
