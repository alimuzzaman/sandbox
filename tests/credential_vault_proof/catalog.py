...
_TYPED_PREDICATES = {
    ...
    "controller_unit_identity_expected": "unit_identity",
    ...
    "controller_executable_ownership_expected": "executable_ownership",
...
_CHECKS = (
    ...
    _check("controller_unit_identity_expected", "service_identity"),
    ...
    _check("controller_executable_ownership_expected", "service_identity"),
