...
class TestIngressTraefik(unittest.TestCase):
    def test_renderer_exists_but_privileged_adoption_is_not_enabled(self):
        ...
        self.assertNotIn("Traefik file provider is not enabled", helper)
        self.assertNotIn("candidate contains a forbidden key", helper)
