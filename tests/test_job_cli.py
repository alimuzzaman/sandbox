...
class JobCliTests(unittest.TestCase):
    ...
    def test_remote_follow_stops_with_bounded_status_recovery(self):
        ...
        args = SimpleNamespace(
            remote="vps", job_id="a" * 32, stream="combined", cursor=None,
            offset=None, tail_bytes=None, lines=None, since=None, max_bytes=1024,
            wait_seconds=0, follow=True, encoding="utf8", json=True, profile="full",
        )
        output = StringIO()
